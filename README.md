...
- **Java 11 or Higher:** Ensure that Java is installed on your system. You can verify the installation by running:
...
4. **Run the Application**
   ...
   After a successful build, you can execute the application using:
